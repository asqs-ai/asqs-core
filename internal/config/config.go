...
type RetrievalConfig struct {
	...
	FailureHintFile string `yaml:"failure_hint_file"`
	...
	PersistLastEvalFailure bool `yaml:"persist_last_eval_failure"`
	...
	DisableHybridModuleFilter bool `yaml:"disable_hybrid_module_filter"`
	...
	AbstentionDisabled bool `yaml:"abstention_disabled"`
...
type IndexerConfig struct {
	...
	DockerJavaImage string `yaml:"docker_java_image"`
	...
	AdvancedJarPath string `yaml:"advanced_jar_path"`
	...
	JSTIndexerPath string `yaml:"jst_indexer_path"`
	...
	CSharpIndexerDllPath string `yaml:"csharp_indexer_dll_path"`
	...
	DockerDotNetIndexerImage string `yaml:"docker_dotnet_indexer_image"`
	...
	OverviewDocPath string `yaml:"overview_doc_path"`
	...
	DisableOverviewDocGeneration bool `yaml:"disable_overview_doc_generation"`
	...
	OverviewFullRewrite bool `yaml:"overview_full_rewrite"`
	...
	OverviewMaxFilesPerSlice int `yaml:"overview_max_files_per_slice"`
	...
	OverviewMaxIndexRunesPerSlice int `yaml:"overview_max_index_runes_per_slice"`
	...
	MonoRepoWorkspace string `yaml:"mono_repo_workspace"`
	...
	MonoRepoTestWorkspace string `yaml:"mono_repo_test_workspace"`
}
...
type LLMConfig struct {
	...
	DisableEmbeddingCache bool `yaml:"disable_embedding_cache"`
	// EmbeddingCacheRetentionDays prunes cache rows unused for this long. 0 = 30 days.
	// Env: LLM_EMBEDDING_CACHE_RETENTION_DAYS.
	EmbeddingCacheRetentionDays int `yaml:"embedding_cache_retention_days"`
	...
	DocProvider             string `yaml:"doc_provider"`
	DocModel                string `yaml:"doc_model"`
	DocAPIKey               string `yaml:"doc_api_key"`
	DocAPIKeyFromEnv        string `yaml:"doc_api_key_from_env"`
	GenerationProvider      string `yaml:"generation_provider"`
	GenerationModel         string `yaml:"generation_model"`
	GenerationAPIKey        string `yaml:"generation_api_key"`
	GenerationAPIKeyFromEnv string `yaml:"generation_api_key_from_env"`
	FixerProvider           string `yaml:"fixer_provider"`
	FixerModel              string `yaml:"fixer_model"`
	FixerAPIKey             string `yaml:"fixer_api_key"`
	FixerAPIKeyFromEnv      string `yaml:"fixer_api_key_from_env"`
	...
	EmbeddingAPIKeyFromEnv string `yaml:"embedding_api_key_from_env"`
	...
	HTTPDisableKeepAlives bool `yaml:"http_disable_keep_alives"`
...
type GenerationConfig struct {
	...
	PromptedToolsEnabled bool `yaml:"prompted_tools_enabled"`
	...
	FixerToolsEnabled bool `yaml:"fixer_tools_enabled"`
	...
	FixerMaxToolTurns int `yaml:"fixer_max_tool_turns"`
}
...
type RunnerConfig struct {
	...
	ImageJava string `yaml:"image_java"`
	...
	ImageJavaMaven string `yaml:"image_java_maven"`
	...
	ImageJavaGradle string `yaml:"image_java_gradle"`
	// ImageNode is the Docker image for JS/TS docker eval (default: node:20-bookworm).
	ImageNode string `yaml:"image_node"`
	...
	ImagePlaywright string `yaml:"image_playwright"`
	...
	ImagePlaywrightJava string `yaml:"image_playwright_java"`
	...
	DockerDisableOfflineTest bool `yaml:"docker_disable_offline_test"`
	// JobReadonlyRootfs uses read-only root + tmpfs /tmp in eval containers (default false).
	JobReadonlyRootfs bool `yaml:"job_readonly_rootfs"`
	// CacheMavenHost bind-mount for Maven repo cache (empty = no mount).
	CacheMavenHost string `yaml:"cache_maven_host"`
	// CacheGradleHost for Gradle user home .gradle.
	CacheGradleHost string `yaml:"cache_gradle_host"`
	// CacheNpmHost for npm cache.
	CacheNpmHost string `yaml:"cache_npm_host"`
	// CachePnpmHost for pnpm store.
	CachePnpmHost string `yaml:"cache_pnpm_host"`
	// CacheNuGetHost for NuGet packages.
	CacheNuGetHost string `yaml:"cache_nuget_host"`
	...
	CacheCypressHost string `yaml:"cache_cypress_host"`
	...
	RequireDockerBootstrap bool `yaml:"require_docker_bootstrap"`
	...
	FormatOnlyAdded bool `yaml:"format_only_added"`
	...
	DisableStructuredFixOutput bool `yaml:"disable_structured_fix_output"`
	...
	FixerDependencySignatureOnly bool `yaml:"fixer_dependency_signature_only"`
	...
	FixerStructuredUserMessage bool `yaml:"fixer_structured_user_message"`
	...
	DisableStructuredGenerateOutput bool `yaml:"disable_structured_generate_output"`
	...
	TwoPhaseTestGeneration bool `yaml:"two_phase_test_generation"`
	...
	SkipFixerOnInfrastructureFailure bool `yaml:"skip_fixer_on_infrastructure_failure"`
	...
	DisableErrorLogLLMSummary bool `yaml:"disable_error_log_llm_summary"`
	...
	FixContextRunesMax int `yaml:"fix_context_runes_max"`
	...
	FixBackoff string `yaml:"fix_backoff"`
	...
	FixLoopRepeatStopThreshold     int `yaml:"fix_loop_repeat_stop_threshold"`
	FixLoopRecurrenceStopThreshold int `yaml:"fix_loop_recurrence_stop_threshold"`
	FixLoopNoProgressStopThreshold int `yaml:"fix_loop_no_progress_stop_threshold"`
